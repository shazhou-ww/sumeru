...
export function createHostHandler(input: {
	...
	const router = createRouter({
		...
		.route("POST", "/prototypes/:name", prototypes.add)
		...
		.route("POST", "/personas/:name", personas.add)
		.route("PUT", "/personas/:name", personas.update)
